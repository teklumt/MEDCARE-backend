...
import { IMasterMedication } from '../types';
import { DOSAGE_FORMS, MEDICATION_CATEGORIES } from '../config/constants';

const masterMedicationSchema = new Schema<IMasterMedication>({
...
export default mongoose.model<IMasterMedication>('MasterMedication', masterMedicationSchema);
